...
import 'package:shop/Details/DrinkDetail.dart';
...
class Topdrink extends StatefulWidget {
  @override
  _TopdrinkState createState() => _TopdrinkState();
}

class _TopdrinkState extends State<Topdrink> {
  Future<List<Shop>> _getallshop;

  getfood() async {
    setState(() {
      _getallshop = getallshop_api_drink();
    });
  }
                                  ...
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(builder: (context) {
                                      return Fooddetails(
                                        ...
                                        shopLatitude: snapshot.data[index].shopLatitude,
                                        shopLongtitude:
                                        snapshot.data[index].shopLongtitude,
                                        shopPicPromote1:
                                        snapshot.data[index].shopPicPromote1,
                                        shopPicPromote2: snapshot
                                            .data[index].shopPicPromote2,
                                        shopPicPromote3:
                                        snapshot.data[index].shopPicPromote3,
                                        shopMenuPic1: snapshot.data[index].shopMenuPic1,
                                        shopMenuPic2: snapshot.data[index].shopMenuPic2,
                                        shopMenuPic3: snapshot.data[index].shopMenuPic3,
                                        shopMenuPic4: snapshot.data[index].shopMenuPic4,
                                        shopMenuPic5: snapshot.data[index].shopMenuPic5,
                                        shopMenuPic6: snapshot.data[index].shopMenuPic6,
