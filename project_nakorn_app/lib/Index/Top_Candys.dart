...
class Topcandy extends StatefulWidget {
  @override
  _TopcandyState createState() => _TopcandyState();
}

class _TopcandyState extends State<Topcandy> {
  Future<List<Shop>> _getallshop;

  getfood() async {
    setState(() {
      _getallshop = getallshop_api_candy();
    });
  }
