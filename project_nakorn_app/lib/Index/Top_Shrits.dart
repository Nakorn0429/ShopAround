...
class Topshirt extends StatefulWidget {
  @override
  _TopshirtState createState() => _TopshirtState();
}

class _TopshirtState extends State<Topshirt> {
  Future<List<Shop>> _getallshop;

  getfood() async {
    setState(() {
      _getallshop = getallshop_api_shirt();
    });
  }
